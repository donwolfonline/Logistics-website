            ...
            on: {
                beforeInit: function () {
                    ...
                    if ($('.box-slide-customers').length > 0) {
                        $('.box-slide-customers').css('padding-inline-start', leftTitle + 'px')
                    }
                },
            },
            breakpoints: {
    ...
    swiper_4_customers = new Swiper('.swiper-group-4-customers', {
        ...
        on: {
            beforeInit: function () {
                ...
                if (isRTL) {
                    if($('.box-slide-customers').length > 0) {
                        $('.box-slide-customers').css('padding-inline-start', $(window).width() - titleFleet.innerWidth() - titleFleet.offset().left + 'px');
                    }
                } else {
                    if($('.box-slide-customers').length > 0) {
                        $('.box-slide-customers').css('padding-inline-start', titleFleet.offset().left + 'px');
                    }
                }
            },
        },

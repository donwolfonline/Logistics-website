    ...
    @if ($isDefaultLanguage)
        <div class="d-flex justify-content-between">
            <button
                ...
                data-bs-target="#addNewCustomFieldModal"
                type="button"
            >{{ trans('plugins/logistics::logistics.custom_field.add_a_new_custom_field') }}</button>
        </div>
    @endif

    <div
        class="modal fade"
        id="addNewCustomFieldModal"
        tabindex="-1"
    >
            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">
                        <i class="til_img"></i>
                        <strong>{{ trans('plugins/logistics::logistics.custom_field.modal.heading') }}</strong>
                    </h4>
                    <button
                        class="btn-close"
                ...
                <div class="modal-body">
                    <div>
                        <label
                            for="custom-field-id">{{ trans('plugins/logistics::logistics.custom_field.modal.select_field') }}</label>
                        <div class="ui-select-wrapper">
                            ...
                            >
                                <option value="">
                                    {{ trans('plugins/logistics::logistics.custom_field.add_a_new_custom_field') }}
                                </option>
                ...
                <div class="modal-footer">
                    ...
                    <button
                        ...
                        id="add-new"
                        type="button"
                    >{{ trans('plugins/logistics::logistics.custom_field.modal.button') }}</button>
                </div>
            </div>
        </div>
    </div>
